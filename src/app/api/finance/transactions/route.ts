...
export async function GET() { try { return NextResponse.json(await financialControlService.listTransactions(await financialControlAuthorization.requireContext())); } catch (error) { return financialRouteError(error); } }
