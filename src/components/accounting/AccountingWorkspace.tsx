...
import { formatMinorUnitsDecimal, minorUnitsToDecimalInput } from '@/lib/finance/money';
...
function OverviewView({ overview }: { overview: Overview }) {
  const cards = [['Operating inflows', dollars(overview.inflowMinor)], ['Operating outflows', dollars(overview.outflowMinor)], ['Operating net', dollars(overview.operatingNetMinor)], ['Reconciled', dollars(overview.reconciledMinor)], ['Unresolved', dollars(overview.unresolvedMinor)], ['Completeness', percentage(overview.completenessBasisPoints)], ['Statements registered', overview.statementsRegistered], ['Imported successfully', overview.statementsImportedSuccessfully], ['Import failed', overview.statementsImportFailed], ['Pending statements', overview.statementsPending], ['Raw records', overview.rawRecordsImported], ['Transfers', overview.transferCount]];
