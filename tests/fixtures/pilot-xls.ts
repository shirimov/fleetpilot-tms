...
export function pilotXlsFixture(options: { invoiceNumber?: string; billingDate?: string; dueDate?: string; unitNumber?: string; productCode?: string; amount?: number; total?: number; transactionDate?: string; formula?: boolean; adjustment?: number; additionalProductCode?: string; additionalAmount?: number; rowsBeforeTotal?: unknown[][] } = {}) {
